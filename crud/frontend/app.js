    ...
    const visualizar = (data) => {
      ...
      for (let i = 0; i < data.baul.length; i++) {
        ...
        b += `<tr>
          ...
          <td><button type="button" class="btn btn-info" onclick="location.href = 'edit.html?variable1=${data.baul[i].id_baul}'"><img src="https://cdn.icon-icons.com/icons2/2778/PNG/512/create_edit_modify_icon_176960.png" height="30" width="30"></button>
          <button type="button" class="btn btn-warning" onclick="eliminar(${data.baul[i].id_baul})"><img src="https://cdn-icons-png.flaticon.com/512/3807/3807871.png" height="30" width="30"></button></td>
        </tr>`;
      }
